...
[![npm](https://img.shields.io/npm/v/@agentlens/openai?color=6366f1)](https://www.npmjs.com/package/@agentlens/openai)
...
import '@agentlens/openai'          // ← auto-patches on import
...
Import order matters: `@agentlens/openai` must be imported before creating any `OpenAI` client instances.
...
```typescript
import { patch, unpatch, patches } from '@agentlens/openai/patcher'
...
```typescript
import { patches } from '@agentlens/openai/patcher'
